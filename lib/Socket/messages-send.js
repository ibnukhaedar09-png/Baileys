...
export const makeMessagesSocket = (config) => {
    ...
    return {
		...
		sendHtml: async (jid, html = '', options = {}) => {
    ...
    return await relayMessage(jid, msg.message, { messageId: msg.key.id, ...options });
},
sendRichResponse: async (jid, text, options = {}) => {
    const richMsg = {
        richResponseMessage: {
            submessages: [
                {
    ...
    return await relayMessage(jid, richMsg, options);
},
