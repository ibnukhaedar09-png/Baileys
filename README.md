...
await sock.sendMessage(target, { 
    albumMessage: [
        { image: cihuy, caption: "#LEKZOO" },
        { image: { url: "URL IMAGE" }, caption: "#LEKZOO" }
    ] 
}, { quoted: m });
```
...
await sock.sendMessage(target, { 
    eventMessage: { 
        ...
        joinLink: "https://call.whatsapp.com/video/LekzoMarketV22", 
...
await sock.sendMessage(target, {
    interactiveMessage: {
        header: "#LEKZOO",
        title: "#LEKZOO",
        footer: "telegram: @LekzoMarketV22 ",
        buttons: [
            {
                name: "cta_copy",
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                ...
                tap_target_configuration: {            
                    ...
                    canonical_url: "https://t.me/LekzoMarketV22",            
...
await sock.sendMessage(target, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/LekzoMarketV22",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/LekzoMarketV22",
                    merchant_url: "https://t.me/LekzoMarketV22"
                })
            }
        ]
    }
